...
void Effect5::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect5::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect5::keyboardEvent(SDL_KeyboardEvent key)
{
}
