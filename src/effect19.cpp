...
void Effect19::resize(int w, int h)
{
...
void Effect19::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect19::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect19::keyboardEvent(SDL_KeyboardEvent key)
{
}
