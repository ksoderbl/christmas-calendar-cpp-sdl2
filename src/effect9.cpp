...
void Effect9::resize(int w, int h)
{
...
void Effect9::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect9::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect9::keyboardEvent(SDL_KeyboardEvent key)
{
}
