...
void Effect11::resize(int w, int h)
{
...
void Effect11::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect11::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect11::keyboardEvent(SDL_KeyboardEvent key)
{
}
