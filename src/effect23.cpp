...
void Effect23::resize(int w, int h)
{
...
void Effect23::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect23::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect23::keyboardEvent(SDL_KeyboardEvent key)
{
}
