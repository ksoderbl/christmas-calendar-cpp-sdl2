...
void Effect7::resize(int w, int h)
{
...
void Effect7::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect7::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect7::keyboardEvent(SDL_KeyboardEvent key)
{
}
