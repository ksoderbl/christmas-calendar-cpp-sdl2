...
void Effect13::mouseButtonDownEvent(SDL_MouseButtonEvent button)
{
}

void Effect13::mouseMotionEvent(SDL_MouseMotionEvent motion)
{
}

void Effect13::keyboardEvent(SDL_KeyboardEvent key)
{
}
